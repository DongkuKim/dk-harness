...
Basic doc correctness is now checked by `pnpm run docs:check` in the source repo, including required files, relative links, and documented `just` commands.

Repeat this manual work when scaffold behavior, architecture rules, onboarding flow, or product framing change:
